        ...
        bImagem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions(
                        CadastroPerguntaActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
                                            ...
                                            if(spRespostaCerta.getSelectedItemPosition()!=0){
                                                if (spNivelDificuldade.getSelectedItemPosition()!=0){
                                                    if (spQuestaoVestibular.getSelectedItemPosition()!=0){
                                                        ...
                                                        Toast.makeText(CadastroPerguntaActivity.this, retornoPergunta, Toast.LENGTH_SHORT).show();

                                                    } else {
                                                        Toast.makeText(CadastroPerguntaActivity.this, "Informe se a questão é de vestibular ou não!", Toast.LENGTH_SHORT).show();
                                                    }
                                                }else {
                                                    Toast.makeText(CadastroPerguntaActivity.this, "Informe o nível de dificuldade da questão!", Toast.LENGTH_SHORT).show();
                                                }
                                            }else {
