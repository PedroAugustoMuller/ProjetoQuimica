...
public class MainLoginActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(!etUsuario.getText().toString().equals("")){
                    if(!etSenha.getText().toString().equals("")){
                        ...
                        if (meuUsuario != null) {
                            ...
                            Intent it = new Intent(MainLoginActivity.this, MainTipoActivity.class);
                            startActivity(it);
                        } else {
                            Toast.makeText(MainLoginActivity.this, "Usuário ou senha incorretos!", Toast.LENGTH_SHORT).show();
                            limpaCampos();
                        }
                    }else{
        ...
        bCadastrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(MainLoginActivity.this, CadastroUsuarioActivity.class);
                startActivity(it);
            }
        });
