        ...
        bProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (posicao != (listaPerguntas.size() - 1)){
                    ...
                    Toast.makeText(QuizActivity.this, "Não existem mais perguntas!", Toast.LENGTH_SHORT).show();
                }
        ...
        bAnterior.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (posicao != 0){
                    ...
                    Toast.makeText(QuizActivity.this, "Você está na primeira pergunta!", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (respondeuTodas == true) {
                    ...
                    if (tipo == 1) { //quiz
                        ...
                        Intent it = new Intent(QuizActivity.this, FeedbackActivity.class);
                        it.putExtra("listaNivelConteudos", listaNivelConteudos);
                        it.putExtra("listaFeedbacks", listaFeedbacks);
                    ...
                    Toast.makeText(QuizActivity.this, "DESEMPENHO NO QUESTIONARIO\nData: " + desempenhoQuestionario.getData() + ", pontuação final: " + desempenhoQuestionario.getPontuacaoFinal(), Toast.LENGTH_LONG).show();
                    Toast.makeText(QuizActivity.this, "DESEMPENHO POR CONTEÚDO: ", Toast.LENGTH_SHORT).show();
