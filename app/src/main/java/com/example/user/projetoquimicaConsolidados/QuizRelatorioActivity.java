...
public class QuizRelatorioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (it.hasExtra("listaPerguntas")) {
            ...
            adapter = new RelatorioPerguntaAdapter(listaPerguntas, trataCliqueItem, QuizRelatorioActivity.this);
            rvRelatorioVisualizaPerguntas.setLayoutManager(new LinearLayoutManager(QuizRelatorioActivity.this));
    ...
    RelatorioPerguntaAdapter.PerguntaOnClickListener trataCliqueItem = new RelatorioPerguntaAdapter.PerguntaOnClickListener() {
        ...
        public void onClickPergunta(View view, int position) {
            ...
            Intent it = new Intent(QuizRelatorioActivity.this, VisualizacaoDetalhadaPerguntasActivity.class);
